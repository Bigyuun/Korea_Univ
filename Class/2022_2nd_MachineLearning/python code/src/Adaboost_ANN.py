...
model_ann.add(Dropout)
model_ann.add(Dense(10, activation='softmax'))
model_ann.compile(optimizer='adam',
                  loss='sparse_categorical_crossentropy',
                  metrics=['accuracy'])
model_ann.fit(input_train, target_train, epochs=10)
model_ann.save("../src_model/Adaboost_ANN.h5")
...
fail_pred_ABC_100 = np.sum(np.logical_xor(target_test, pred_ABC_100))
