...
model_dctree = DecisionTreeClassifier(min_impurity_decrease=0.0005, random_state=0)
...
# plot_tree(model_dctree, max_depth=3, filled=True)
plot_tree(model_dctree, max_depth=1, filled=True)
plt.show()
