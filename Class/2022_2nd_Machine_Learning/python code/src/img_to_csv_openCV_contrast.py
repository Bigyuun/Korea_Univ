...
img_mod_pixel = cv2.resize(dst1, dsize=(28,28), interpolation=cv2.INTER_AREA)
img_mod_pixel = img_mod_pixel.reshape(1,-1)
...
# cv2.imshow('dst1', img_mod_pixel)
# # cv2.imshow('gray', img_gray_contrast)
# cv2.waitKey(0)
